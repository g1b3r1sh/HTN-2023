...
def generate_text(examples, topic, top_text):
...
def main():
    generate_text([('PUSH IN THE SIDES OF YOUR TIN FOIL PACKAGE', 'TWILL KEEP THE BOLL FROM FALLING OUT'), ('THE NIGHT BEFORE, PLACE THINGS YOU DON\'T WANT TO FORGET THE NEXT MORNING...', 'CN TOP OF YOUR SHOES')], 'Lays Chips', 'Eat Lays Chips everyday...')
